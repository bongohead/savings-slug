...
\t\t\t\t\t\t<span>Monthly Budget (Work in Progress)</span>
\t\t\t\t\t</div>
\t\t\t\t</a>
\t\t\t\t
...
\t\t\t\t\t\t<h5 class=\"text-uppercase\" style=\"color:white\">BUDGET </h5>
\t\t\t\t\t\t<p>Under development</p>
\t\t\t\t\t</div>\t\t
\t\t\t\t\t<div class=\"col-md-6 mb-md-0 mb-3\">
\t\t\t\t\t\t<h5 class=\"text-uppercase\">Under development</h5>
...
\t\t\t\t<div class=\"footer-copyright text-center\">© 2021
\t\t\t\t\t<a href=\"test\">Under development</a>
\t\t\t\t</div>\t\t\t
\t\t\t</div>
\t\t</div>
\t\t\t
